...
public class DataType {
    ...
    public static final String PersonalInfo_Other = "Any other personal information such as date of birth, gender identity, veteran status, etc.";
    ...
    public static final String FinancialInfo_Other = "Any other financial information such as user salary or debts.";
    ...
    public static final String Messages_OtherInAppMessages = "Any other types of messages. For example, instant messages or chat content.";
    ...
    public static final String AudioFiles_Other = "Any other user-created or user-provided audio files.";
    ...
    public static final String AppActivity_OtherActions = "Any other user activity or actions in-app not listed here such as gameplay, likes, and dialog options.";
